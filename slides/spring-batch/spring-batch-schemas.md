...
```
BATCH_JOB_INSTANCE ||--|{ BATCH_JOB_EXECUTION : instances
BATCH_JOB_EXECUTION ||--|{ BATCH_JOB_EXECUTION_PARAMS : parameters
BATCH_JOB_EXECUTION ||--|| BATCH_JOB_EXECUTION_CONTEXT : context
BATCH_JOB_EXECUTION ||--|{ BATCH_STEP_EXECUTION : steps
