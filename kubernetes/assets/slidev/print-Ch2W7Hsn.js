import{d as _,a4 as u,z as h,f as s,g as t,t as o,T as c,F as f,aj as g,o as a,i as v,e as x,ad as b}from"../modules/vue-Bo_l8wuD.js";import{a as y,u as N,x as d}from"../index-CRoQQuYP.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-pNMUCH2T.js";import"../modules/shiki-B1wnBfLT.js";const T={id:"page-root"},w={class:"m-4"},L={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},z={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:m,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
